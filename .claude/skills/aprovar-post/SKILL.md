...
### Passo 0 — Verificar integrações

```bash
node --env-file=.env scripts/verificar-integracoes.js
```

Se reportar problema (token da Meta vencido, Página/Instagram inacessível, site fora do ar), parar e resolver antes de qualquer coisa — é melhor descobrir agora do que com o blog já publicado e o post travado no meio.
