...
- O sistema `hdevCRM/` é um **fork do Chatwoot** em processo de white-label. Objetivo: substituir toda a marca "Chatwoot" por "HDEV CRM" (branding visível), preservando os identificadores internos de código que quebrariam se renomeados.
