...
class Message < ApplicationRecord
  searchkick callbacks: false if HdevApp.advanced_search_allowed?
  ...
  def should_index?
    return false unless HdevApp.advanced_search_allowed?
    ...
    return false if HdevApp.chatwoot_cloud? && !account.feature_enabled?('advanced_search_indexing')
