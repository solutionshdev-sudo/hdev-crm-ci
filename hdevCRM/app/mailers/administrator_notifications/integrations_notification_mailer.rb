class AdministratorNotifications::IntegrationsNotificationMailer < AdministratorNotifications::BaseMailer
  def slack_disconnect
    subject = I18n.t('mailers.integrations_notification_mailer.slack_disconnect.subject')
    action_url = settings_url('integrations/slack')
    send_notification(subject, action_url: action_url)
  end

  def dialogflow_disconnect
    subject = I18n.t('mailers.integrations_notification_mailer.dialogflow_disconnect.subject')
    send_notification(subject)
  end

  def openai_disconnect
    subject = I18n.t('mailers.integrations_notification_mailer.openai_disconnect.subject')
