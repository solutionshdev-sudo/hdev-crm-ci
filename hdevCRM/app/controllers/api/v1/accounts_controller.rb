class Api::V1::AccountsController < Api::BaseController
  ...
  def create
    @user, @account = AccountBuilder.new(
      ...
      user: current_user,
      agency: Agency.resolve_by_host(request.host)
    ).perform
  ...
  def validate_captcha
    raise ActionController::InvalidAuthenticityToken, 'Invalid Captcha' unless HdevCaptcha.new(params[:h_captcha_client_response]).valid?
  end
