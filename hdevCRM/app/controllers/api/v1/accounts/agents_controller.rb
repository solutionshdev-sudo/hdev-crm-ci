class Api::V1::Accounts::AgentsController < Api::V1::Accounts::BaseController
  ...
  def validate_limit_for_bulk_create
    ...
    render_payment_required(I18n.t('errors.api.account.agent_limit_exceeded')) unless limit_available
  end

  def validate_limit
    render_payment_required(I18n.t('errors.api.account.agent_limit_exceeded')) unless can_add_agent?
  end
