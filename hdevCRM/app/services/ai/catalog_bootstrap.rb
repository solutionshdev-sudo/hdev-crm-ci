class Ai::CatalogBootstrap
  ...
  class << self
    def run!
      ...
      models = CATALOG.map do |canonical_id, display_name, default_for_provider|
        seed_model(connection, canonical_id, display_name, default_for_provider)
      end
