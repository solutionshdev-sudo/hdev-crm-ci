Rails.application.routes.draw do
  ...
  namespace :api, defaults: { format: 'json' } do
    namespace :v1 do
      # ----------------------------------
      # agency scoped api routes (white-label reseller layer)
  ...
  devise_scope :super_admin do
    ...
    namespace :super_admin do
      ...
      resources :agencies, only: [:index, :new, :create, :show, :edit, :update, :destroy] do
        delete :logo, on: :member, action: :destroy_logo
        delete :logo_dark, on: :member, action: :destroy_logo_dark
        delete :logo_thumbnail, on: :member, action: :destroy_logo_thumbnail
      end
      ...
      resources :agency_users, only: [:new, :create, :show, :destroy]
    end
