    ...
    context 'when posting to accounts with correct parameters' do
      ...
      it 'calls account builder' do
        with_modified_env ENABLE_ACCOUNT_SIGNUP: 'true' do
          ...
          expect(AccountBuilder).to have_received(:new).with(params.except(:password).merge(user_password: params[:password], agency: nil))
      ...
      it 'renders error response on invalid params' do
        with_modified_env ENABLE_ACCOUNT_SIGNUP: 'true' do
          ...
          expect(AccountBuilder).to have_received(:new).with(params.merge(user_password: params[:password], agency: nil))
          expect(account_builder).to have_received(:perform)
