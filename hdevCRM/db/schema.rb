...
ActiveRecord::Schema[7.1].define(version: 2026_07_31_000005) do
  ...
  create_table "agency_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["agency_id", "user_id"], name: "index_agency_users_on_agency_id_and_user_id", unique: true
    t.index ["agency_id"], name: "index_agency_users_on_agency_id"
    t.index ["user_id"], name: "index_agency_users_on_user_id"
  end
  ...
  create_table "ai_usage_events", force: :cascade do |t|
    ...
    t.decimal "cost", precision: 12, scale: 8, default: "0.0", null: false
    t.jsonb "metadata", default: {}, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "created_at"], name: "index_ai_usage_events_on_account_id_and_created_at"
    t.index ["account_id"], name: "index_ai_usage_events_on_account_id"
    t.index ["agency_id", "created_at"], name: "index_ai_usage_events_on_agency_id_and_created_at"
    t.index ["agency_id"], name: "index_ai_usage_events_on_agency_id"
  end
  ...
  create_table "channel_web_widgets", id: :serial, force: :cascade do |t|
    ...
    t.string "widget_color", default: "#00875A"
